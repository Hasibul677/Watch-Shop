          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                <option value="Rolex 3236 Automatic Movement">
                  Rolex 3236 Automatic Movement
                </option>
                <option value="Rolex 3237 Automatic Movement">
                  Rolex 3237 Automatic Movement
                </option>
                <option value="Patek Philipe 5677 Automatic Movement">
                  Patek Philipe 5677 Automatic Movement
                </option>
                <option value="Patek Philipe 5678 Automatic Movement">
                  Patek Philipe 5678 Automatic Movement
                </option>
                <option value="Audemars Piguet 8887 Automatic Movement">
                  Audemars Piguet 8887 Automatic Movement
                </option>
                <option value="Audemars Piguet 8888 Automatic Movement">
