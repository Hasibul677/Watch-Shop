...
const WatchHero = () => {
    ...
    return (
        <div className="relative sm:h-[55rem] h-screen w-full overflow-hidden">
            ...
            >
                <source
                    src="https://res.cloudinary.com/dikhyqnzw/video/upload/v1742359429/videoplayback_nucz0s.mp4"
                    type="video/mp4"
                />
            ...
            {/* Overlay */}
            <div className="absolute inset-0 px-2 sm:px-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
                <motion.h1
                ...
                <motion.p
                    className="mb-8 text-xl md:text-2xl text-center max-w-2xl"
                    initial={{ opacity: 0, y: -50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.2 }}
                >
                    Precision, style, and craftsmanship perfected for your wrist.
                </motion.p>
                <motion.div
